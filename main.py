...
LR = ['Locathah']
MTF = ['Dwarf (Duergar)', 'Elf (Eladrin)', 'Elf (Sea)',
       'Elf (Shadar-kai)', 'Gith (Githyanki)', 'Gith (Githzerai)', 'Gnome (Deep)', 'Tiefling (Asmodeus)',
       'Tiefling (Baalzebul)', 'Tiefling (Dispater)', 'Tiefling (Fierna)', 'Tiefling (Glasya)', 'Tiefling (Levistus)',
       'Tiefling (Mammon)', 'Tiefling (Mephistopheles)', 'Tiefling (Zariel)']
